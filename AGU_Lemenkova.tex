...
\begin{itemize}
        	\item \textcolor{red}{Concept}: Large and complex massifs (collections) of digital Earth (spatial) data
	...
	\item \textcolor{red}{VVV}: Three major magic 'V' characterising Big Data: \textcolor{ProcessBlue}{volume} (unprecedented wealth of data),  \textcolor{ProcessBlue}{velocity} (both the growth rate and the demand for high-speed cartographic processing and mapping), \textcolor{ProcessBlue}{variety} (multi-source heterogeneous spatial data $=>$ need for simultaneous handling of various types of structured and non-structured data \cite{Yangetal2019}
...
\end{figure}
Pacific Ocean differs in \textcolor{DarkOrchid}{western} and \textcolor{DarkOrchid}{eastern} parts according to relief, geotectonics and geological evolution.
...
\begin{itemize}
	\item Python can handle a huge amount of data, which it uses not only to process, but also to create analytical plots, such as assessment of bathymetric variability or analytics in geology. 
	 ...
	 \item Scripting approach with more readable syntax $=>$ easier to learn than R
	 \item Open-source
\end{itemize}
\end{exampleblock}
\begin{exampleblock}{Statistical Analysis by R}
\begin{itemize}
	 \item Reputable high-level programming language
	 \item Statistical analysis is supported by powerful variety of algorithms in R packages 
	 \item Effectiveness specifically in advanced scientific statistical data analysis
	 \item Complex syntax with scripting approach $=>$ flexibility of data processing (big tables, data frames)
	 \item Beauty \& elegance of graphs (e.g. packages: \{ggplot\}, \{tidyverse\})
	 \item Open source 
\end{itemize}
\end{exampleblock}
\end{frame}
...
\begin{frame}\frametitle{Big Data Repositories}
\begin{minipage}[0.4\textheight]{\textwidth}
\begin{columns}[T]
\begin{column}{0.4\textwidth}
\vspace{2em}
\begin{itemize}\small
            \item Satellite Altimetry and Earth Observation (EO) have generated huge massives of data. 
            \item The retrieval of geoinformation in the repositories is not a easy task which requires a multi-disciplinary approach
...
Geoid model (EGR96) of the Kuril-Kamchatka Trench and Kamchatka Peninsula. \cite{Lemenkova201995}
\end{column}
...
\begin{figure}[H]
	...
	\caption{Cross-section bathymetric profiles across the Kuril-Kamchatka Trench. \cite{Lemenkova201995}}
\end{figure}
\end{frame}
...
3D visualization of the Kuril-Kamchatka Trench and Kamchatka Peninsula geomorphic structure. \cite{Lemenkova201995}
\end{column}
\begin{column}{0.5\textwidth}
\vspace{2em}
...
\begin{figure}[H]
	...
	\caption{Mindmap of the project: methods, concepts, approaches and tools. \\Plotting: \LaTeX \space \cite{Lemenkova201993}}\label{fig:MT20}
\end{figure}
\end{frame}
...
\begin{figure}[H]
	...
	\caption{Normalized steepness slope calculation of the cross-section profiles: R library \{ggplot\}, \cite{RCoreTeam2014}. \cite{Lemenkova201871}}\label{fig:MT5}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Boxplots of the cross-section profiles: R based statistical analysis. \cite{Lemenkova201871}}\label{fig:MT4}
\end{figure}
\end{column}
\begin{column}{0.6\textwidth}
\begin{figure}[L]
\vspace{2em}
	...
	\caption{Violin plots of the profiles: R based statistical plotting. \cite{Lemenkova201866}}\label{fig:MT6}
\end{figure}
